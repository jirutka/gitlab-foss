  ...
  describe Asciidoc do
    ...
    context "without project" do
      ...
      it "should convert the input using Asciidoctor and default options" do
        ...
        expect( render_asciidoc(input, context) ).to eql html
      end
      ...
      context "with asciidoc_opts" do
        ...
        it "should merge the options with default ones" do
          ...
          render_asciidoc(input, context, asciidoc_opts)
        end
      end
    end
    ...
    context "with project in context" do
      ...
      it "should filter converted input via HTML pipeline and return result" do
        ...
        expect( render_asciidoc('foo', context) ).to eql filtered_html
      end
    end

    def render_asciidoc(*args)
      described_class.render_asciidoc(*args)
    end
  end
end
